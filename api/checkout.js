...
module.exports = async function handler(req, res) {
  try {
    ...
    const params = {
      ...
      'custom_fields[1][key]': 'ideal_customer',
      'custom_fields[1][label][type]': 'custom',
      'custom_fields[1][label][custom]': 'Who is your ideal customer?',
      'custom_fields[1][type]': 'text',
      'custom_fields[2][key]': 'main_competitor',
      'custom_fields[2][label][type]': 'custom',
      'custom_fields[2][label][custom]': 'Who is your main competitor?',
